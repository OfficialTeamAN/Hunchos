      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 relative">
            ...
            {/* Pause Overlay */}
            <div className="absolute inset-0 z-50 flex flex-col mt-32 items-center justify-start">
              <div className="bg-[#0c0c0d]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-8 flex flex-col items-center text-center shadow-[0_20px_60px_rgba(0,0,0,0.8)] max-w-sm mx-auto">
                ...
                <h3 className="text-2xl font-black font-display tracking-tight text-white uppercase mb-3">Leaderboard Paused</h3>
                <p className="text-xs text-white/60 font-semibold uppercase tracking-wider leading-relaxed">The live tracker is currently paused. Please check back later.</p>
              </div>
            </div>

            <div className="flex flex-col gap-12 blur-[8px] opacity-40 pointer-events-none select-none transition-all duration-500">
